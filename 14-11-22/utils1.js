 ...
 */
 ...
 /**
  * Select an element that match with the ID passed as argument
  * 	 
  * @param {id} el - specific class name 
  * @returns HTMLElement 
  */
  const gI = (el) => document.getElementById(el);
