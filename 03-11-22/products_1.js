const products = [
      ...
      },
      {
        "id": 7,
        "name": "Toblerone",
        "logo": "/images/tobelron.jfif",
        "desc":
          "Toblerone (/ˈtoʊbləroʊn/; German: [tobləˈroːnə]) is a Swiss chocolate bar brand[1] owned by US confectionery company Mondelēz International, Inc., formerly Kraft Foods, which acquired the product from former owner Jacobs Suchard in 1990. It is produced in Bern[2] (the bear symbol of the city is still visible in the logo) and in early 2000 was being produced in the United States by Ferrara Pan candy company in Bellwood, Illinois.[citation needed] Toblerone is well known for its distinctive triangular prism shape."
      },
      {
        "id": 8,
        "name": "Cadbury",
